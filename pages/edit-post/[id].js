...
export default function EditPost() {
    ...
    async function fetchPost() {
        ...
        if (process.env.NEXT_PUBLIC_ENVIRONMENT === 'local') {
            ...
            provider = new ethers.providers.JsonRpcProvider('https://rinkeby.arbitrum.io/rpc')
          } else {
    ...
    return (
        <div className={container}>
            ...
            <button className={button} onClick={() => setEditing(editing ? false : true)}>{ editing
            ? 'View Post' : 'Edit Post'} </button>
        </div>
    )
}
